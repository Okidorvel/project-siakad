...
class Nilai extends CI_Controller
{
  ...
  function __construct()
    {
        parent::__construct();
        $this->load->model('M_transkrip'); // Memanggil Transkrip_model yang terdapat pada models
		$this->load->model('M_users'); // Memanggil Users_model yang terdapat pada models
